...
namespace Farmlife
{
    public class BlockBehaviorFoodMilkContainer : BlockBehavior
    {
        ICoreAPI api;
        BlockLiquidContainerBase lcblock;

        public BlockBehaviorFoodMilkContainer(Block block) : base(block) { }
        ...
        {
            EntityBehaviorFoodMilk bh;
            if (entitySel != null && (bh = entitySel.Entity.GetBehavior<EntityBehaviorFoodMilk>()) != null)
            {
        ...
        {
            EntityBehaviorFoodMilk bh;
            if (secondsUsed > 2.95f && entitySel != null && (bh = entitySel.Entity.GetBehavior<EntityBehaviorFoodMilk>()) != null)
            {
